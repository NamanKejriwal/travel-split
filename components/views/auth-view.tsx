...
// 2. Update itemVariants (it's likely right below)
const itemVariants = {
  ...
  return (
    ...
    <div className="flex min-h-screen items-center justify-center bg-[#020617] p-4 relative overflow-hidden font-sans selection:bg-[#00A896] selection:text-white">
      ...
      <motion.div 
        ...
        animate="visible"
        layout 
        // RESTORED: bg-[#020617]/60 with blur (Glassmorphism)
      ...
      >
        ...
        <div className="text-center mb-8 pt-6">
            <motion.div 
              ...
              // FIXED: Increased mb-8 for more spacing
...
<motion.div variants={itemVariants}>
            <Button 
                variant="outline" 
                // CHANGED: Removed 'bg-white text-black' and replaced with 'bg-white/5 text-white hover:bg-white/10'
                // This makes the button dark (matching the theme) with white text.
          ...
          <motion.div variants={itemVariants} className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase tracking-widest">
              {/* FIXED: Background matches card color to hide line behind text */}
